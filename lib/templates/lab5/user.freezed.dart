...
mixin _$User {
  ...
  Map<String, String> get company => throw _privateConstructorUsedError;
...
class _$UserImpl implements _User {
  const _$UserImpl(
      ...
      required final Map<String, String> company})
      : _address = address,
        _company = company;
...
abstract class _User implements User {
  const factory _User(
      ...
      required final Map<String, String> company}) = _$UserImpl;
